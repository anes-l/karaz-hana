    ...
    return (
        <div className="min-h-[80vh] flex items-center justify-center bg-cream px-4">
            <div className="bg-white p-8 md:p-12 rounded-lg shadow-lg border border-charcoal/5 w-full max-w-md relative overflow-hidden">
                {/* Decoration */}
                <div className="absolute top-0 left-0 w-20 h-20 bg-sage/5 rounded-br-[4rem]" />

                <h2 className="font-serif text-3xl text-charcoal mb-8 text-center">Créer un compte</h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        <label className="block text-sm font-medium text-charcoal/70 mb-1">Confirmer le mot de passe</label>
                        <input
                            type="password"
                            required
                            className="w-full px-4 py-3 border border-charcoal/10 rounded-md focus:outline-none focus:ring-1 focus:ring-terracotta bg-cream/20"
                ...
                <div className="mt-8 text-center text-sm text-charcoal/60">
                    Déjà un compte ?{' '}
                    <Link to="/login" className="text-terracotta hover:underline underline-offset-4">
                        Se connecter
                    </Link>
                </div>
            </div>
